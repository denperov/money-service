...
api_get()  { \
 printf '\nrequest: %s\n' "$1" >&2; \
 status=$(curl -w "%{http_code}" -o "./pipe_for_curl_out" -s "${api_url}$1"); \
...
api_post "/transfers" '{"transfer":{"from_account":"usd01","to_account":"usd02","amount":"12.34"}}'
assert_ok

echo ------------------------------------------------------------------------------
echo Transfer monye RUB
api_post "/transfers" '{"transfer":{"from_account":"rub01","to_account":"rub02","amount":"12.34"}}'
assert_ok

echo ------------------------------------------------------------------------------
echo Transfer all monye from the account
api_post "/transfers" '{"transfer":{"from_account":"usd03","to_account":"usd04","amount":"100.00"}}'
assert_ok

echo ------------------------------------------------------------------------------
echo Transfer zero monye
api_post "/transfers" '{"transfer":{"from_account":"usd05","to_account":"usd06","amount":"0.00"}}'
assert_user_error
...
api_post "/transfers" '{"transfer":{"from_account":"usd07","to_account":"rub03","amount":"12.34"}}'
assert_user_error
...
echo ------------------------------------------------------------------------------
echo Transfer monye
api_post "/transfers" '{"transfer":{"from_account":"xxx","to_account":"usd02","amount":"12.34"}}'
assert_user_error

# Nonexistent destination account
echo ------------------------------------------------------------------------------
echo Transfer monye
api_post "/transfers" '{"transfer":{"from_account":"usd01","to_account":"xxx","amount":"12.34"}}'
assert_user_error
